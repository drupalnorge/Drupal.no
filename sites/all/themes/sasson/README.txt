 ...
 * File watcher - See changes happen in real time. Sasson will auto-
 magically update your browser whenever you modify your stylesheets (or any 
 ...
 * Sasson gives you a responsive layout - that means your site adapts itself 
 ...
 disable this behaviour via theme settings
 
 * The default responsive layout takes a desktop-first approach, you can go 
 mobile-first with a click in your theme settings.
 
 * While you develop, you should keep the development mode turned on (see 
 theme settings page), this will compile your SASS on every page load, and 
 will give you FireSASS support (https://addons.mozilla.org/en-
 ...
 * Sasson applies classes to the <html> tag to enable easier styling for 
 Internet Exporer :
